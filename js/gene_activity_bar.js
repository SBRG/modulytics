/**
 * @summary Creates interactive gene activity bar plots for Modulytics
 * @author Kevin Rychel and Katherine Decker
        ...
        tooltip: {
            formatter: function() {
                ...
                if (this.series.name == 'X_avg') {
                    ...
                    // activity 
                    tooltip += 'Avg Expression: '+ this.point.y.toFixed(2);
                    if (data[index][4] > 1) {
                    ...
                    // activity
                    tooltip += 'Expression: '+ this.point.y.toFixed(2);
                }
